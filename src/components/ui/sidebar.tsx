      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex w-full flex-1 overflow-hidden has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden h-full text-sidebar-foreground md:flex md:flex-col",
