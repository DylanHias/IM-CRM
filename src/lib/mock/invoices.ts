...
const mockInvoiceItems: InvoiceSearchItem[] = [
  ...
  {
    invoiceNumber: 'INV-2026-016', invoiceStatus: 'Open', invoiceDate: '2026-03-15', invoiceDueDate: '2026-04-15',
    invoicedAmountDue: 18500.00, invoiceAmountInclTax: 22385.00, customerOrderNumber: 'PO-5016',
    endCustomerOrderNumber: null, orderCreateDate: '2026-03-10', erpOrderNumber: 'ERP-90016', paymentTermsDueDate: '2026-04-15',
  },
  {
    invoiceNumber: 'INV-2026-017', invoiceStatus: 'Paid', invoiceDate: '2025-12-01', invoiceDueDate: '2025-12-31',
    invoicedAmountDue: 0, invoiceAmountInclTax: 9680.00, customerOrderNumber: 'PO-5017',
    endCustomerOrderNumber: 'EC-106', orderCreateDate: '2025-11-25', erpOrderNumber: 'ERP-90017', paymentTermsDueDate: '2025-12-31',
  },
  {
    invoiceNumber: 'INV-2026-018', invoiceStatus: 'Past Due', invoiceDate: '2025-10-15', invoiceDueDate: '2025-11-15',
    invoicedAmountDue: 34200.00, invoiceAmountInclTax: 41382.00, customerOrderNumber: 'PO-5018',
    endCustomerOrderNumber: null, orderCreateDate: '2025-10-10', erpOrderNumber: 'ERP-90018', paymentTermsDueDate: '2025-11-15',
  },
  {
    invoiceNumber: 'INV-2026-019', invoiceStatus: 'Open', invoiceDate: '2026-02-05', invoiceDueDate: '2026-03-05',
    invoicedAmountDue: 6750.00, invoiceAmountInclTax: 8167.50, customerOrderNumber: 'PO-5019',
    endCustomerOrderNumber: 'EC-107', orderCreateDate: '2026-01-30', erpOrderNumber: 'ERP-90019', paymentTermsDueDate: '2026-03-05',
  },
  {
    invoiceNumber: 'INV-2026-020', invoiceStatus: 'Paid', invoiceDate: '2026-01-12', invoiceDueDate: '2026-02-12',
    invoicedAmountDue: 0, invoiceAmountInclTax: 14520.00, customerOrderNumber: 'PO-5020',
    endCustomerOrderNumber: null, orderCreateDate: '2026-01-08', erpOrderNumber: 'ERP-90020', paymentTermsDueDate: '2026-02-12',
  },
  {
    invoiceNumber: 'INV-2026-021', invoiceStatus: 'Open', invoiceDate: '2026-03-18', invoiceDueDate: '2026-04-18',
    invoicedAmountDue: 42600.00, invoiceAmountInclTax: 51546.00, customerOrderNumber: 'PO-5021',
    endCustomerOrderNumber: null, orderCreateDate: '2026-03-14', erpOrderNumber: 'ERP-90021', paymentTermsDueDate: '2026-04-18',
  },
  {
    invoiceNumber: 'INV-2026-022', invoiceStatus: 'Past Due', invoiceDate: '2025-11-10', invoiceDueDate: '2025-12-10',
    invoicedAmountDue: 2890.00, invoiceAmountInclTax: 3496.90, customerOrderNumber: 'PO-5022',
    endCustomerOrderNumber: null, orderCreateDate: '2025-11-05', erpOrderNumber: 'ERP-90022', paymentTermsDueDate: '2025-12-10',
  },
  {
    invoiceNumber: 'INV-2026-023', invoiceStatus: 'Paid', invoiceDate: '2025-09-20', invoiceDueDate: '2025-10-20',
    invoicedAmountDue: 0, invoiceAmountInclTax: 24200.00, customerOrderNumber: 'PO-5023',
    endCustomerOrderNumber: 'EC-108', orderCreateDate: '2025-09-15', erpOrderNumber: 'ERP-90023', paymentTermsDueDate: '2025-10-20',
  },
  {
    invoiceNumber: 'INV-2026-024', invoiceStatus: 'Open', invoiceDate: '2026-03-20', invoiceDueDate: '2026-04-20',
    invoicedAmountDue: 11250.00, invoiceAmountInclTax: 13612.50, customerOrderNumber: 'PO-5024',
    endCustomerOrderNumber: null, orderCreateDate: '2026-03-16', erpOrderNumber: 'ERP-90024', paymentTermsDueDate: '2026-04-20',
  },
  {
    invoiceNumber: 'INV-2026-025', invoiceStatus: 'Paid', invoiceDate: '2026-02-10', invoiceDueDate: '2026-03-10',
    invoicedAmountDue: 0, invoiceAmountInclTax: 56870.00, customerOrderNumber: 'PO-5025',
    endCustomerOrderNumber: null, orderCreateDate: '2026-02-05', erpOrderNumber: 'ERP-90025', paymentTermsDueDate: '2026-03-10',
  },
  {
    invoiceNumber: 'INV-2026-026', invoiceStatus: 'Past Due', invoiceDate: '2025-12-05', invoiceDueDate: '2026-01-05',
    invoicedAmountDue: 7820.00, invoiceAmountInclTax: 9462.20, customerOrderNumber: 'PO-5026',
    endCustomerOrderNumber: 'EC-109', orderCreateDate: '2025-12-01', erpOrderNumber: 'ERP-90026', paymentTermsDueDate: '2026-01-05',
  },
  {
    invoiceNumber: 'INV-2026-027', invoiceStatus: 'Open', invoiceDate: '2026-03-22', invoiceDueDate: '2026-04-22',
    invoicedAmountDue: 3450.00, invoiceAmountInclTax: 4174.50, customerOrderNumber: 'PO-5027',
    endCustomerOrderNumber: null, orderCreateDate: '2026-03-18', erpOrderNumber: 'ERP-90027', paymentTermsDueDate: '2026-04-22',
  },
  {
    invoiceNumber: 'INV-2026-028', invoiceStatus: 'Paid', invoiceDate: '2025-10-25', invoiceDueDate: '2025-11-25',
    invoicedAmountDue: 0, invoiceAmountInclTax: 19360.00, customerOrderNumber: 'PO-5028',
    endCustomerOrderNumber: null, orderCreateDate: '2025-10-20', erpOrderNumber: 'ERP-90028', paymentTermsDueDate: '2025-11-25',
  },
  {
    invoiceNumber: 'INV-2026-029', invoiceStatus: 'Open', invoiceDate: '2026-01-28', invoiceDueDate: '2026-02-28',
    invoicedAmountDue: 15900.00, invoiceAmountInclTax: 19239.00, customerOrderNumber: 'PO-5029',
    endCustomerOrderNumber: 'EC-110', orderCreateDate: '2026-01-22', erpOrderNumber: 'ERP-90029', paymentTermsDueDate: '2026-02-28',
  },
  {
    invoiceNumber: 'INV-2026-030', invoiceStatus: 'Paid', invoiceDate: '2025-09-10', invoiceDueDate: '2025-10-10',
    invoicedAmountDue: 0, invoiceAmountInclTax: 72600.00, customerOrderNumber: 'PO-5030',
    endCustomerOrderNumber: null, orderCreateDate: '2025-09-05', erpOrderNumber: 'ERP-90030', paymentTermsDueDate: '2025-10-10',
  },
  {
    invoiceNumber: 'INV-2026-031', invoiceStatus: 'Past Due', invoiceDate: '2025-11-28', invoiceDueDate: '2025-12-28',
    invoicedAmountDue: 4150.00, invoiceAmountInclTax: 5021.50, customerOrderNumber: 'PO-5031',
    endCustomerOrderNumber: null, orderCreateDate: '2025-11-22', erpOrderNumber: 'ERP-90031', paymentTermsDueDate: '2025-12-28',
  },
  {
    invoiceNumber: 'INV-2026-032', invoiceStatus: 'Open', invoiceDate: '2026-03-05', invoiceDueDate: '2026-04-05',
    invoicedAmountDue: 27350.00, invoiceAmountInclTax: 33093.50, customerOrderNumber: 'PO-5032',
    endCustomerOrderNumber: 'EC-111', orderCreateDate: '2026-03-01', erpOrderNumber: 'ERP-90032', paymentTermsDueDate: '2026-04-05',
  },
  {
    invoiceNumber: 'INV-2026-033', invoiceStatus: 'Paid', invoiceDate: '2026-02-18', invoiceDueDate: '2026-03-18',
    invoicedAmountDue: 0, invoiceAmountInclTax: 6050.00, customerOrderNumber: 'PO-5033',
    endCustomerOrderNumber: null, orderCreateDate: '2026-02-12', erpOrderNumber: 'ERP-90033', paymentTermsDueDate: '2026-03-18',
  },
  {
    invoiceNumber: 'INV-2026-034', invoiceStatus: 'Open', invoiceDate: '2026-01-15', invoiceDueDate: '2026-02-15',
    invoicedAmountDue: 8900.00, invoiceAmountInclTax: 10769.00, customerOrderNumber: 'PO-5034',
    endCustomerOrderNumber: null, orderCreateDate: '2026-01-10', erpOrderNumber: 'ERP-90034', paymentTermsDueDate: '2026-02-15',
  },
  {
    invoiceNumber: 'INV-2026-035', invoiceStatus: 'Paid', invoiceDate: '2025-12-20', invoiceDueDate: '2026-01-20',
    invoicedAmountDue: 0, invoiceAmountInclTax: 31460.00, customerOrderNumber: 'PO-5035',
    endCustomerOrderNumber: 'EC-112', orderCreateDate: '2025-12-15', erpOrderNumber: 'ERP-90035', paymentTermsDueDate: '2026-01-20',
  },
  {
    invoiceNumber: 'INV-2026-036', invoiceStatus: 'Past Due', invoiceDate: '2025-10-01', invoiceDueDate: '2025-10-31',
    invoicedAmountDue: 1250.00, invoiceAmountInclTax: 1512.50, customerOrderNumber: 'PO-5036',
    endCustomerOrderNumber: null, orderCreateDate: '2025-09-25', erpOrderNumber: 'ERP-90036', paymentTermsDueDate: '2025-10-31',
  },
  {
    invoiceNumber: 'INV-2026-037', invoiceStatus: 'Open', invoiceDate: '2026-03-10', invoiceDueDate: '2026-04-10',
    invoicedAmountDue: 53200.00, invoiceAmountInclTax: 64372.00, customerOrderNumber: 'PO-5037',
    endCustomerOrderNumber: null, orderCreateDate: '2026-03-05', erpOrderNumber: 'ERP-90037', paymentTermsDueDate: '2026-04-10',
  },
  {
    invoiceNumber: 'INV-2026-038', invoiceStatus: 'Paid', invoiceDate: '2025-11-15', invoiceDueDate: '2025-12-15',
    invoicedAmountDue: 0, invoiceAmountInclTax: 4840.00, customerOrderNumber: 'PO-5038',
    endCustomerOrderNumber: null, orderCreateDate: '2025-11-10', erpOrderNumber: 'ERP-90038', paymentTermsDueDate: '2025-12-15',
  },
  {
    invoiceNumber: 'INV-2026-039', invoiceStatus: 'Open', invoiceDate: '2026-02-22', invoiceDueDate: '2026-03-22',
    invoicedAmountDue: 14700.00, invoiceAmountInclTax: 17787.00, customerOrderNumber: 'PO-5039',
    endCustomerOrderNumber: 'EC-113', orderCreateDate: '2026-02-18', erpOrderNumber: 'ERP-90039', paymentTermsDueDate: '2026-03-22',
  },
  {
    invoiceNumber: 'INV-2026-040', invoiceStatus: 'Past Due', invoiceDate: '2025-09-28', invoiceDueDate: '2025-10-28',
    invoicedAmountDue: 21500.00, invoiceAmountInclTax: 26015.00, customerOrderNumber: 'PO-5040',
    endCustomerOrderNumber: null, orderCreateDate: '2025-09-22', erpOrderNumber: 'ERP-90040', paymentTermsDueDate: '2025-10-28',
  },
  {
    invoiceNumber: 'INV-2026-041', invoiceStatus: 'Paid', invoiceDate: '2026-01-08', invoiceDueDate: '2026-02-08',
    invoicedAmountDue: 0, invoiceAmountInclTax: 38720.00, customerOrderNumber: 'PO-5041',
    endCustomerOrderNumber: null, orderCreateDate: '2026-01-03', erpOrderNumber: 'ERP-90041', paymentTermsDueDate: '2026-02-08',
  },
  {
    invoiceNumber: 'INV-2026-042', invoiceStatus: 'Open', invoiceDate: '2026-03-25', invoiceDueDate: '2026-04-25',
    invoicedAmountDue: 5600.00, invoiceAmountInclTax: 6776.00, customerOrderNumber: 'PO-5042',
    endCustomerOrderNumber: 'EC-114', orderCreateDate: '2026-03-20', erpOrderNumber: 'ERP-90042', paymentTermsDueDate: '2026-04-25',
  },
  {
    invoiceNumber: 'INV-2026-043', invoiceStatus: 'Paid', invoiceDate: '2025-10-18', invoiceDueDate: '2025-11-18',
    invoicedAmountDue: 0, invoiceAmountInclTax: 11616.00, customerOrderNumber: 'PO-5043',
    endCustomerOrderNumber: null, orderCreateDate: '2025-10-12', erpOrderNumber: 'ERP-90043', paymentTermsDueDate: '2025-11-18',
  },
  {
    invoiceNumber: 'INV-2026-044', invoiceStatus: 'Open', invoiceDate: '2026-02-28', invoiceDueDate: '2026-03-28',
    invoicedAmountDue: 79500.00, invoiceAmountInclTax: 96195.00, customerOrderNumber: 'PO-5044',
    endCustomerOrderNumber: null, orderCreateDate: '2026-02-22', erpOrderNumber: 'ERP-90044', paymentTermsDueDate: '2026-03-28',
  },
  {
    invoiceNumber: 'INV-2026-045', invoiceStatus: 'Past Due', invoiceDate: '2025-12-10', invoiceDueDate: '2026-01-10',
    invoicedAmountDue: 6320.00, invoiceAmountInclTax: 7647.20, customerOrderNumber: 'PO-5045',
    endCustomerOrderNumber: 'EC-115', orderCreateDate: '2025-12-05', erpOrderNumber: 'ERP-90045', paymentTermsDueDate: '2026-01-10',
  },
];

// Map reseller IDs to invoice indices
const RESELLER_INVOICE_MAP: Record<string, number[]> = {
  'RSL-10001': [0, 1, 2, 6, 11, 15, 20, 25, 30, 37],
  'RSL-10002': [3, 4, 9, 16, 21, 26, 31, 38],
  'RSL-10003': [5, 7, 12, 14, 17, 22, 27, 32, 39],
  'RSL-10004': [8, 10, 13, 18, 23, 28, 33],
  'RSL-10005': [1, 5, 10, 19, 24, 29, 34, 40],
  'RSL-10006': [0, 3, 7, 15, 35, 41],
  'RSL-10007': [1, 8, 14, 16, 36, 42],
  'RSL-10008': [2, 4, 11, 17, 37, 43],
  'RSL-10009': [5, 9, 13, 18, 38, 44],
  'RSL-10010': [0, 6, 12, 19, 39, 40],
  'RSL-10011': [3, 10],
  'RSL-10012': [1, 7, 14],
  'RSL-10013': [2, 5, 8, 11],
  'RSL-10014': [4, 9, 13],
...
const mockInvoiceDetails: Record<string, InvoiceDetail> = {
  ...
  'INV-2026-016': {
    invoiceNumber: 'INV-2026-016', invoiceStatus: 'Open', invoiceDate: '2026-03-15', invoiceDueDate: '2026-04-15',
    customerOrderNumber: 'PO-5016', endCustomerOrderNumber: null, erpOrderNumber: 'ERP-90016', orderCreateDate: '2026-03-10',
    billToInfo: { companyName: 'VlaamseTech NV', addressLine1: 'Groenplaats 18', addressLine2: null, city: 'Antwerp', state: null, postalCode: '2000', countryCode: 'BE' },
    shipToInfo: { companyName: 'VlaamseTech NV', addressLine1: 'Groenplaats 18', addressLine2: null, city: 'Antwerp', state: null, postalCode: '2000', countryCode: 'BE' },
    paymentTermsInfo: { paymentTermsDescription: 'Net 30', paymentTermsDueDate: '2026-04-15', paymentTermsNetDays: 30 },
    lines: [
      { ingramPartNumber: 'IM-SRV-020', vendorPartNumber: 'HPE-DL380-G11-P', vendorName: 'HP Enterprise', productDescription: 'HPE ProLiant DL380 Gen11 Premium', quantity: 2, unitPrice: 7200.00, extendedPrice: 14400.00, taxAmount: 3024.00, quantityOrdered: 2, quantityShipped: 0, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-MEM-064', vendorPartNumber: 'SK-DDR5-64', vendorName: 'SK Hynix', productDescription: 'SK Hynix DDR5 64GB ECC RDIMM', quantity: 8, unitPrice: 350.00, extendedPrice: 2800.00, taxAmount: 588.00, quantityOrdered: 8, quantityShipped: 0, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-SSD-012', vendorPartNumber: 'MCRN-9400-3T', vendorName: 'Micron', productDescription: 'Micron 9400 3.2TB NVMe SSD', quantity: 4, unitPrice: 325.00, extendedPrice: 1300.00, taxAmount: 273.00, quantityOrdered: 4, quantityShipped: 0, currencyCode: 'EUR' },
    ],
    summary: { totalLines: 3, totalAmount: 18500.00, totalTax: 3885.00, totalAmountInclTax: 22385.00, currencyCode: 'EUR' },
  },
  'INV-2026-021': {
    invoiceNumber: 'INV-2026-021', invoiceStatus: 'Open', invoiceDate: '2026-03-18', invoiceDueDate: '2026-04-18',
    customerOrderNumber: 'PO-5021', endCustomerOrderNumber: null, erpOrderNumber: 'ERP-90021', orderCreateDate: '2026-03-14',
    billToInfo: { companyName: 'Port of Antwerp IT Dept', addressLine1: 'Zaha Hadidplein 1', addressLine2: null, city: 'Antwerp', state: null, postalCode: '2030', countryCode: 'BE' },
    shipToInfo: { companyName: 'Port of Antwerp - DC', addressLine1: 'Noorderlaan 21', addressLine2: 'Building C', city: 'Antwerp', state: null, postalCode: '2030', countryCode: 'BE' },
    paymentTermsInfo: { paymentTermsDescription: 'Net 30', paymentTermsDueDate: '2026-04-18', paymentTermsNetDays: 30 },
    lines: [
      { ingramPartNumber: 'IM-NET-040', vendorPartNumber: 'CSCO-C9500-48Y', vendorName: 'Cisco', productDescription: 'Cisco Catalyst 9500 48-Port 25G Switch', quantity: 4, unitPrice: 8500.00, extendedPrice: 34000.00, taxAmount: 7140.00, quantityOrdered: 4, quantityShipped: 4, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-NET-041', vendorPartNumber: 'CSCO-DNA-A-3Y', vendorName: 'Cisco', productDescription: 'Cisco DNA Advantage License 3Y', quantity: 4, unitPrice: 2150.00, extendedPrice: 8600.00, taxAmount: 1806.00, quantityOrdered: 4, quantityShipped: 4, currencyCode: 'EUR' },
    ],
    summary: { totalLines: 2, totalAmount: 42600.00, totalTax: 8946.00, totalAmountInclTax: 51546.00, currencyCode: 'EUR' },
  },
  'INV-2026-030': {
    invoiceNumber: 'INV-2026-030', invoiceStatus: 'Paid', invoiceDate: '2025-09-10', invoiceDueDate: '2025-10-10',
    customerOrderNumber: 'PO-5030', endCustomerOrderNumber: null, erpOrderNumber: 'ERP-90030', orderCreateDate: '2025-09-05',
    billToInfo: { companyName: 'BelgaChem Industries', addressLine1: 'Haven 1040', addressLine2: null, city: 'Antwerp', state: null, postalCode: '2040', countryCode: 'BE' },
    shipToInfo: { companyName: 'BelgaChem Industries - Site B', addressLine1: 'Haven 1040', addressLine2: 'Gate 3', city: 'Antwerp', state: null, postalCode: '2040', countryCode: 'BE' },
    paymentTermsInfo: { paymentTermsDescription: 'Net 30', paymentTermsDueDate: '2025-10-10', paymentTermsNetDays: 30 },
    lines: [
      { ingramPartNumber: 'IM-SRV-025', vendorPartNumber: 'DELL-R760XS', vendorName: 'Dell', productDescription: 'Dell PowerEdge R760xs Rack Server', quantity: 6, unitPrice: 7400.00, extendedPrice: 44400.00, taxAmount: 9324.00, quantityOrdered: 6, quantityShipped: 6, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-STR-025', vendorPartNumber: 'DELL-ME5024', vendorName: 'Dell', productDescription: 'Dell PowerVault ME5024 Storage Array', quantity: 2, unitPrice: 8100.00, extendedPrice: 16200.00, taxAmount: 3402.00, quantityOrdered: 2, quantityShipped: 2, currencyCode: 'EUR' },
    ],
    summary: { totalLines: 2, totalAmount: 60600.00, totalTax: 12726.00, totalAmountInclTax: 72600.00, currencyCode: 'EUR' },
  },
  'INV-2026-037': {
    invoiceNumber: 'INV-2026-037', invoiceStatus: 'Open', invoiceDate: '2026-03-10', invoiceDueDate: '2026-04-10',
    customerOrderNumber: 'PO-5037', endCustomerOrderNumber: null, erpOrderNumber: 'ERP-90037', orderCreateDate: '2026-03-05',
    billToInfo: { companyName: 'Flanders Pharma Group', addressLine1: 'Rijksweg 12', addressLine2: null, city: 'Beerse', state: null, postalCode: '2340', countryCode: 'BE' },
    shipToInfo: { companyName: 'Flanders Pharma Group - Lab', addressLine1: 'Rijksweg 12', addressLine2: 'Building R&D-3', city: 'Beerse', state: null, postalCode: '2340', countryCode: 'BE' },
    paymentTermsInfo: { paymentTermsDescription: 'Net 30', paymentTermsDueDate: '2026-04-10', paymentTermsNetDays: 30 },
    lines: [
      { ingramPartNumber: 'IM-WKS-010', vendorPartNumber: 'LNV-P360-ULT', vendorName: 'Lenovo', productDescription: 'Lenovo ThinkStation P360 Ultra', quantity: 15, unitPrice: 2180.00, extendedPrice: 32700.00, taxAmount: 6867.00, quantityOrdered: 15, quantityShipped: 10, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-MON-015', vendorPartNumber: 'LG-27UK850', vendorName: 'LG', productDescription: 'LG 27UK850 27" 4K IPS Monitor', quantity: 15, unitPrice: 420.00, extendedPrice: 6300.00, taxAmount: 1323.00, quantityOrdered: 15, quantityShipped: 15, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-PER-005', vendorPartNumber: 'LOG-MX-KEYS-S', vendorName: 'Logitech', productDescription: 'Logitech MX Keys S Keyboard', quantity: 15, unitPrice: 80.00, extendedPrice: 1200.00, taxAmount: 252.00, quantityOrdered: 15, quantityShipped: 15, currencyCode: 'EUR' },
    ],
    summary: { totalLines: 3, totalAmount: 40200.00, totalTax: 8442.00, totalAmountInclTax: 64372.00, currencyCode: 'EUR' },
  },
  'INV-2026-044': {
    invoiceNumber: 'INV-2026-044', invoiceStatus: 'Open', invoiceDate: '2026-02-28', invoiceDueDate: '2026-03-28',
    customerOrderNumber: 'PO-5044', endCustomerOrderNumber: null, erpOrderNumber: 'ERP-90044', orderCreateDate: '2026-02-22',
    billToInfo: { companyName: 'EuroCloud Services', addressLine1: 'Keizersgracht 440', addressLine2: null, city: 'Amsterdam', state: null, postalCode: '1016 GD', countryCode: 'NL' },
    shipToInfo: { companyName: 'EuroCloud Services - DC2', addressLine1: 'Schipholweg 300', addressLine2: null, city: 'Hoofddorp', state: null, postalCode: '2153 NL', countryCode: 'NL' },
    paymentTermsInfo: { paymentTermsDescription: 'Net 30', paymentTermsDueDate: '2026-03-28', paymentTermsNetDays: 30 },
    lines: [
      { ingramPartNumber: 'IM-SRV-030', vendorPartNumber: 'HPE-DL560-G11', vendorName: 'HP Enterprise', productDescription: 'HPE ProLiant DL560 Gen11 4-Socket Server', quantity: 3, unitPrice: 18500.00, extendedPrice: 55500.00, taxAmount: 11655.00, quantityOrdered: 3, quantityShipped: 1, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-MEM-128', vendorPartNumber: 'SAM-DDR5-128', vendorName: 'Samsung', productDescription: 'Samsung DDR5 128GB ECC LRDIMM', quantity: 24, unitPrice: 850.00, extendedPrice: 20400.00, taxAmount: 4284.00, quantityOrdered: 24, quantityShipped: 8, currencyCode: 'EUR' },
      { ingramPartNumber: 'IM-SSD-020', vendorPartNumber: 'KXTA-DC600M-3T', vendorName: 'Kingston', productDescription: 'Kingston DC600M 3.84TB Enterprise SSD', quantity: 6, unitPrice: 600.00, extendedPrice: 3600.00, taxAmount: 756.00, quantityOrdered: 6, quantityShipped: 6, currencyCode: 'EUR' },
    ],
    summary: { totalLines: 3, totalAmount: 79500.00, totalTax: 16695.00, totalAmountInclTax: 96195.00, currencyCode: 'EUR' },
  },
};
