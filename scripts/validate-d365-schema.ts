...
const ENTITY_FIELD_MAP: Record<string, EntityFieldMap> = {
  ...
  contact: {
    ...
    pushFields: ['firstname', 'lastname', 'im360_jobfunctions', 'emailaddress1', 'telephone1', 'mobilephone', 'im360_cloudcontact'],
    odataBindings: ['parentcustomerid_account', 'im360_countryId', 'im360_contacttypes'],
    navPropertyLookups: [],
    activityPartyBindings: [],
    collectionNavProperties: [],
  },
